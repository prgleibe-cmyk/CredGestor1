...
export function ConfirmModal({ 
  ...
  return (
    <div 
      className="fixed inset-0 z-[110] flex items-center justify-center p-6 bg-text-main/40 backdrop-blur-xl"
      onClick={onClose}
    >
      <motion.div 
        ...
        className="glass-card w-full max-w-md rounded-[3.5rem] p-10 md:p-12 shadow-[0_50px_100px_rgba(0,0,0,0.1)] border border-border-main relative overflow-hidden text-center"
      >
        ...
        <h3 className="text-3xl md:text-4xl font-display font-black text-text-main mb-4 tracking-tighter leading-tight">
          {title}
        </h3>
        
        <p className="text-text-muted text-lg font-bold leading-relaxed mb-10 px-4">
          {message}
        </p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            onClick={onClose}
            className="w-full py-5 btn-gradient-slate text-white font-black uppercase text-[11px] tracking-[0.3em] rounded-[1.5rem] transition-all border border-border-main shadow-inner active:scale-95"
          >
            {cancelText}
          </button>
        </div>
