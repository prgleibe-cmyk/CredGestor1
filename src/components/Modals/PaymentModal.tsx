  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="p-4 md:p-6 border-b border-border-main flex justify-between items-center gap-6 shrink-0 bg-text-main/5 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="flex-1 p-4 md:p-8 space-y-8 overflow-y-auto relative z-10 custom-scrollbar">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-8">
              <div className="bg-emerald-500/10 p-8 rounded-[2.5rem] border border-emerald-500/20 shadow-inner relative overflow-hidden group">
                ...
                <p className="text-[7px] text-emerald-600 uppercase font-black tracking-[0.3em] mb-2 relative z-10">Cliente</p>
              ...
              {delayDays > 0 && (
                ...
                >
                  ...
                  <div>
                    <p className="text-[7px] font-black text-red-400 uppercase tracking-[0.2em]">Pagamento em Atraso</p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-[7px] text-text-muted uppercase font-black tracking-[0.3em] mb-2 group-hover:text-emerald-600 transition-colors relative z-10">Normal</p>
                ...
                >
                  ...
                  <p className={`text-[7px] uppercase font-black tracking-[0.3em] mb-2 transition-colors relative z-10 ${delayDays > 0 ? 'text-red-600 group-hover:text-red-500' : 'text-text-muted group-hover:text-emerald-600'}`}>
                    Corrigido
                  </p>
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="block text-[7px] font-black text-text-muted uppercase tracking-[0.3em] ml-2">Valor do Pagamento (R$)</label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label className="block text-[7px] font-black text-text-muted uppercase tracking-[0.3em] ml-2">Data do Pagamento</label>
                    <input 
                      type="date" 
                      required
                      value={formData.date}
                  ...
                  <div className="space-y-2">
                    <label className="block text-[7px] font-black text-text-muted uppercase tracking-[0.3em] ml-2">Observações</label>
                    <input 
                      type="text"
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[7px] text-text-muted font-black uppercase tracking-[0.2em]">Confirmação automática</span>
                  </div>
                </div>
              </div>
              ...
              {formData.sendWhatsApp && (
                ...
                >
                  ...
                  <div className="relative z-10">
                    <p className="text-[7px] text-text-muted font-black uppercase tracking-[0.3em] mb-6 text-center">Prévia da Mensagem</p>
                    <div className="bg-emerald-600/10 p-6 rounded-3xl rounded-tl-none border border-emerald-500/20 max-w-[95%] ml-0 relative shadow-2xl">
                      ...
                      <div className="flex justify-end mt-2">
                        <span className="text-[7px] text-emerald-600/50 font-black uppercase">{new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
